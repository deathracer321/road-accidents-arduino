...
SoftwareSerial SIM900(9, 10); //tx,rx
void setup() {
...
void loop() {
  ...
  ShowSerialData();
  delay(5000);
  Serial.print("AT+HTTPPARA=\"URL\",\"webhook.site/4ef003a8-b09f-499b-a723-a5d6bb12a4f7?name=harish\"\r\\n");
  SIM900.println("AT+HTTPPARA=\"URL\",\"webhook.site/4ef003a8-b09f-499b-a723-a5d6bb12a4f7?name=harish&age=13\""); /* Set parameters for HTTP session */
  delay(5000);
  ShowSerialData();
  delay(5000);
